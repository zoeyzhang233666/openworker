...
产品设计与阶段 1 实施计划已获批准。销售主线首包（D-091—D-122）与内容重构 M1+M2（D-104/D-107）已落地。当前：公开查询必显销售 Provider；VAT/汇率/维基已接线；**化工社只读 + 写反应 + SVG 落盘**（D-118/D-119/D-120）；**压缩硬裁提示中性化**（D-121）；**四销售龙虾专属空态三卡**（D-122）。按 GATE 点检 D-108+。以 `docs/chemclaw/README.md` 为准。
