...
const messages = {
  "zh-CN": {
    ...
    "experts.builtin": "内置",
    "mcp.builtin": "内置",
    "mcp.builtinReadonlyHint": "只读，密钥由产品注入",
    ...
    "chart.candle.pinHint": "单击固定 · 双击取消 · Esc",
    "chart.series.hint": "十字线定位最近日期",
    "chart.series.pinHint": "单击固定 · 双击取消 · Esc",
    "chart.crosshair.following": "十字线跟随鼠标",
    "chart.crosshair.pinned": "十字线已固定",
    "ask.recommended": "推荐",
    "ask.previous": "上一个问题",
    "ask.question": "问题",
  ...
  "en-US": {
    ...
    "mcp.builtinReadonlyHint": "read-only; keys injected by the product",
    ...
    "chart.candle.pinHint": "Click to pin · double-click to clear · Esc",
    "chart.series.hint": "Crosshair snaps to nearest date",
    "chart.series.pinHint": "Click to pin · double-click to clear · Esc",
    "chart.crosshair.following": "Crosshair follows cursor",
    "chart.crosshair.pinned": "Crosshair pinned",
