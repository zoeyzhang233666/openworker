...
const PROVIDERS = [
  // chem-cloud ApiHub relay — gallery-first (CN then Intl); unconfigured in fixtures.
  { name: "apihub-cn", title: "ApiHub CN (chem-cloud)", needs_key: true, blurb: "chem-cloud's OpenAI-compatible ApiHub relay (China). Endpoint is prefilled; just add your key.", fields: [{ key: "api_key", label: "ApiHub CN API key", secret: true, required: true, help: "", placeholder: "" }, { key: "base_url", label: "Endpoint", secret: false, required: false, help: "", placeholder: "https://apihub.chem-cloud.cn/v1", default: "https://apihub.chem-cloud.cn/v1" }], configured: false, values: {}, suggested_models: ["deepseek-v4-flash", "deepseek-v4-pro", "glm-5.2", "kimi-k3"], key_set_at: null, last_used_at: null },
  { name: "apihub-intl", title: "ApiHub Intl (chem-cloud)", needs_key: true, blurb: "chem-cloud's OpenAI-compatible ApiHub relay (international). Endpoint is prefilled; just add your key.", fields: [{ key: "api_key", label: "ApiHub Intl API key", secret: true, required: true, help: "", placeholder: "" }, { key: "base_url", label: "Endpoint", secret: false, required: false, help: "", placeholder: "https://www.tokenfoundryx.com/v1", default: "https://www.tokenfoundryx.com/v1" }], configured: false, values: {}, suggested_models: ["gpt-5.6-sol", "gpt-5.6-luna", "gpt-5.6-terra", "claude-sonnet-5", "claude-opus-5", "claude-fable-5"], key_set_at: null, last_used_at: null },
