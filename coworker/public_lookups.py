...
CATALOG: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "purpose_zh": "拉取全球股票/期货日线开高低收，供蜡烛图。大陆 A 股/国内期货/期权请用国内公开行情卡，不替代化工现货 chem-data-hub；非投资建议。",
        "purpose_en": "Fetch global stock/futures daily OHLC for candlesticks. Use CN public market cards for mainland A-shares/futures/options. Not a chem spot substitute; not investment advice.",
        "used_by_zh": "默认 ChemClaw · 美股/港股/全球期货走势问句",
        "used_by_en": "Default ChemClaw · global equity/futures price questions",
    ...
    },
    {
        "id": "cn_stock_public",
        "kind": "free",
        "label_zh": "A 股公开行情（新浪/东财）",
        "label_en": "A-share public quotes (Sina/Eastmoney)",
        "tool": "lookup_cn_stock_ohlc",
        "summary_zh": "已内置 · 无需密钥（报价/K线/财报/龙虎榜/两融/北向历史）",
        "summary_en": "Built-in · no API key (quote/OHLC/financials/LHB/margin/northbound)",
        "purpose_zh": "免登录读取 A 股快照、日线/分钟、三张表、龙虎榜、两融汇总、北向历史。对应 lookup_cn_stock_quote/ohlc/minute/financials/feature。非持牌行情，非投资建议。",
        "purpose_en": "Keyless A-share snapshot, OHLC, statements, LHB, margin, northbound history via lookup_cn_stock_*. Not licensed market data.",
        "used_by_zh": "默认 ChemClaw · 茅台/A股/龙虎榜问句",
        "used_by_en": "Default ChemClaw · A-share and LHB questions",
        "setup_zh": "无需密钥。结构化失败后不要改用网页探测或 Yahoo。",
        "setup_en": "No API key. Do not fall back to web probing or Yahoo after a structured failure.",
        "docs_url": "",
        "signup_url": "",
    },
    {
        "id": "cn_futures_public",
        "kind": "free",
        "label_zh": "国内期货公开行情（新浪）",
        "label_en": "China futures public quotes (Sina)",
        "tool": "lookup_cn_futures_ohlc",
        "summary_zh": "已内置 · 无需密钥（报价/日线/分钟/L1/理论保证金）",
        "summary_en": "Built-in · no API key (quote/OHLC/minute/L1/theoretical margin)",
        "purpose_zh": "免登录读取国内期货 L1、日线、分钟；主力按持仓量本地选取。理论保证金是公式估算，不是期货公司占用。对应 lookup_cn_futures_* 与 calculate_cn_futures_margin。",
        "purpose_en": "Keyless China futures L1/OHLC/minute; dominant contract by open interest. Theoretical margin is not broker occupancy.",
        "used_by_zh": "默认 ChemClaw · 甲醇/液化气等国内期货问句",
        "used_by_en": "Default ChemClaw · domestic futures such as methanol/LPG",
        "setup_zh": "无需密钥。大陆期货不要改走 Yahoo。",
        "setup_en": "No API key. Do not use Yahoo for mainland China futures.",
        "docs_url": "",
        "signup_url": "",
    },
    {
        ...
        "kind": "free",
        "label_zh": "国内期权公开行情",
        "label_en": "China options public quotes",
        "tool": "lookup_cn_option_market",
        "summary_zh": "已内置 · 无需密钥（ETF/股指期权纵切）",
        "summary_en": "Built-in · no API key (ETF/index option slice)",
        "purpose_zh": "上交所 ETF 期权与中金所股指期权的合约、报价、日线/分钟、上游 Greeks。exchange_stats 可能 source_unavailable。Greeks 只转述上游，不本地编造。",
        "purpose_en": "SSE ETF and CFFEX index options: contracts, quotes, OHLC, upstream Greeks only. exchange_stats may be unavailable.",
        "used_by_zh": "默认 ChemClaw · 50ETF/IO 期权问句",
        "used_by_en": "Default ChemClaw · 50ETF/IO option questions",
        "setup_zh": "无需密钥。不做 Tick/L2。",
        "setup_en": "No API key. Tick/L2 is not provided.",
        "docs_url": "",
        "signup_url": "",
    },
    {
