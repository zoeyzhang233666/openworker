...
- 默认交付简洁、可核验的客户清单：主体、角色、产品或应用相关证据、`Lead Fit Score`、`Evidence Confidence`、风险、待补查项和 `RecommendedAction`。收尾时调用 `format_lead_list` 生成 Markdown/CSV 产物（可联系/待补查/已排除），写入工作区供人工经营；不自动外发。
